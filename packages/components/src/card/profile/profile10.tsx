const ProfileCard10 = () => {
  return (
      <div className="card border border-gray-100  transition-shadow test  shadow-lg hover:shadow-shadow-xl w-full text-purple-50 rounded-md bg-green-800">
        <h2 className="text-md mb-2 px-4 pt-4">
          <div className="flex justify-between">
            <div className="badge relative top-0">
              <span className="mt-2 py-1 h-12px text-md font-semibold w-12px  rounded right-1 bottom-1 px-4 text-white">
                Laghouat
              </span>
            </div>
            <span className="text-lg font-bold text-white">6:13</span>
          </div>
        </h2>
        <div className="flex items-center p-4 justify-center">
          <div className="flex justify-center items-center">
            ...
            >
              ...
              <path d="M23.071 5.929H27.071V7.929H23.071z" transform="rotate(-45 25.077 6.931)" />
              <path d="M17 2.005H19V6.005H17z" />
              <path d="M9.929 4.929H11.929V8.929H9.929z" transform="rotate(-45 10.935 6.931)" />
            </svg>
          </div>
        </div>
        <div className="text-md pt-4 pb-4 px-4">
          <div className="flex justify-between items-center">
            ...
            <div>
              <h1 className="text-6xl text-white"> 12° </h1>
            </div>
          </div>
        </div>
      </div>
