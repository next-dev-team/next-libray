const BlogCard10 = () => {
  return (
    <div className="flex flex-col w-full dark:bg-black bg-red-400 rounded shadow-lg">
      <div
      ...
      <div className="flex flex-col w-full md:flex-row">
        ...
        <div className="p-4 font-normal text-gray-800 md:w-3/4">
          ...
          <p className="leading-normal">
            The College Football Playoff (CFP) determines the national champion of the top division
            of college football. The format fits within the academic calendar and
          </p>
